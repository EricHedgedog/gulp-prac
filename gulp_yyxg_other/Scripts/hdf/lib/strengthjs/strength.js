    ...
    Plugin.prototype = {
        ...
        init: function() {
            ...
            function changeLevel(){
                $(".safeUl").find('.active').removeClass('active');
                var strengthRange = $(".strength_meter").children().eq(0).attr('class');
                switch (strengthRange){
                    case "weak":
                        $(".safeUl").find('.low').addClass('active');
                        break;
                    case "medium":
                        $(".safeUl").find('.middle').addClass('active');
                        break;
                    case "strong":
                        $(".safeUl").find('.high').addClass('active');
                        break;
                    default:
                        $(".safeUl").find('.active').removeClass('active');
                }
